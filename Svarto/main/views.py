...
def create_student(request):
    if request.method == 'POST':
        ...
        try:
            ...
            student = Student.objects.create(first_name=first_name, last_name=last_name, class_id=class_instance)
            return JsonResponse({
                'status': 'ok',
                'student_id': student.id,  # Adding the student ID in response
            })
